<ul role="list" class="flex h-full flex-1 flex-col gap-4 mt-2">
    ...
    <li class="relative h-full">
        <div class="absolute inset-0 z-50 h-full">
            <ul role="list" class="relative h-full space-y-0.5">
                ...
                {{-- Dashboard --}}
                <li class="group" data-onboarding="owner-dashboard">
                ...
                {{-- Leases --}}
                <li class="group" data-onboarding="owner-leases">
                ...
                {{-- Units --}}
                 <li class="group" data-onboarding="owner-units">
                ...
                {{-- Payments --}}
                <li class="group" data-onboarding="owner-payments">
                ...
                {{-- Complaints / Requests --}}
                <li class="group" data-onboarding="owner-requests">
                ...
                {{-- FAQs --}}
                <li class="group" data-onboarding="owner-faqs">
    ...
    <li class="mt-auto h-auto relative">
        <ul role="list" class="space-y-0.5">
            ...
            <li class="group" data-onboarding="owner-properties">
            ...
            {{-- Settings --}}
            <li class="group" data-onboarding="owner-settings">
            ...
            <li class="group">
                <button
                    x-data
                    @click="$dispatch('restart-onboarding-tour')"
                    class="w-full flex items-center gap-x-2 py-2.5 px-4.5 text-sm font-medium leading-6 text-neutral-700 dark:text-neutral-200 border-l-4 border-transparent transition-all duration-200 ease-in-out group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/40 group-hover:text-primary dark:group-hover:text-indigo-400 group-hover:border-primary"
                >
                    <x-ui.icon name="academic-cap" class="size-5 shrink-0 group-hover:text-primary dark:group-hover:text-indigo-400" />
                    <span class="h-5 leading-5">
                        Revisit Tour
                    </span>
                </button>
