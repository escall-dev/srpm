<ul role="list" class="flex h-full flex-1 flex-col gap-4 mt-2">
    ...
    <li class="relative h-full">
        <div class="absolute inset-0 z-50 h-full">
            <ul role="list" class="relative h-full space-y-0.5">
                ...
                {{-- Dashboard --}}
                <li class="group" data-onboarding="tenant-dashboard">
                 ...
                 {{-- Leases --}}
                 <li class="group" data-onboarding="tenant-leases">
                  ...
                  {{-- Payments --}}
                  <li class="group" data-onboarding="tenant-payments">
                   ...
                   {{-- Complaints / Requests --}}
                   <li class="group" data-onboarding="tenant-requests">
                   ...
                   {{-- FAQs --}}
                   <li class="group" data-onboarding="tenant-faqs">
    ...
    <li class="mt-auto h-auto relative">
        <ul role="list" class="space-y-0.5">
            ...
            {{-- Settings --}}
            <li class="group" data-onboarding="tenant-settings">
